...
The full step-by-step build guide (with field-value tables and copy-paste notes) lives in [`docs/ServiceNow_ITSM_Lab_Documentation.docx`](https://github.com/mccraym7/ad-labset-004/blob/adc3e14d891b067c1fabd79a0a8e5194c69f36e0/servicenow-itsm-lab.zip).
